pub const ONE_TO_NINETEEN: [&str; 19] = [
    "one",
    "two",
    "three",
    "four",
...
pub const TENS: [&str; 9] = [
    "ten", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety",
];

pub const MAGNITUDES: [&str; 1000] = [
    "thousand",
    "million",
    "billion",
    "trillion",
...
pub const DECIMALS: [&str; 51] = [
    ...
    "duodecillionth",
    "ten-duodecillionth",
    "hundred-duodecillionth",
    "tredecillionth",
    "ten-tredecillionth",
    "hundred-tredecillionth",
    "quattuordecillionth",
    "ten-quattuordecillionth",
    "hundred-quattuordecillionth",
    "quindecillionth",
    "ten-quindecillionth",
    "hundred-quindecillionth",
    "sexdecillionth",
];
